# This Makefile is for the Inline::CPP extension to perl.
#
...
#     NAME => q[Inline::CPP]
#     PREREQ_PM => { Inline::C=>q[0.42] }
#     VERSION_FROM => q[CPP.pm]
#     clean => { FILES=>q[_Inline/ grammar/_Inline] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Inline/CPP.pod

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Inline
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Inline
...
PM_TO_BLIB = CPP.pm \
	$(INST_LIB)/Inline/CPP.pm \
	lib/Inline/CPP.pod \
	blib/lib/Inline/CPP.pod
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Inline/CPP.pod $(INST_MAN3DIR)/Inline::CPP.$(MAN3EXT) 
...
subdirs ::
	$(NOECHO) cd grammar && $(MAKE) $(USEMAKEFILE) $(FIRST_MAKEFILE) all $(PASTHRU)


# --- MakeMaker clean_subdirs section:
clean_subdirs :
	$(ABSPERLRUN)  -e 'chdir '\''grammar'\'';  system '\''$(MAKE) clean'\'' if -f '\''$(FIRST_MAKEFILE)'\'';' --
...
realclean_subdirs :
	- $(ABSPERLRUN)  -e 'chdir '\''grammar'\'';  system '\''$(MAKE) $(USEMAKEFILE) $(MAKEFILE_OLD) realclean'\'' if -f '\''$(MAKEFILE_OLD)'\'';' --
	- $(ABSPERLRUN)  -e 'chdir '\''grammar'\'';  system '\''$(MAKE) $(USEMAKEFILE) $(FIRST_MAKEFILE) realclean'\'' if -f '\''$(FIRST_MAKEFILE)'\'';' --
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                Inline-CPP' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Inline::C:                     0.42' >> META_new.yml
...
subdirs-test ::
	$(NOECHO) cd grammar && $(MAKE) test $(PASTHRU)
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Inline-C" VERSION="0,42,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  CPP.pm $(INST_LIB)/Inline/CPP.pm \
	  lib/Inline/CPP.pod blib/lib/Inline/CPP.pod 
